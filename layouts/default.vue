  ...
  <div>
    ...
    <div class="container">
      <div class="row" style="position: fixed; z-index: 100000;">
        ...
        <section class="tm-section-head pt-2 ptop-sm-5" id="top">
          <div class="row px-0 py-0">
            <div class="col-lg-7 col-md-5 col-sm-5 text-md-center">
              <header id="header" class="float-left tm-text-gray">
                <nuxt-link to="/">
                  <img class="img-fluid pt-2" src="/img/logo_top.png" alt="">
                </nuxt-link>
              </header>
            </div>
            <div class="info col-lg-5 col-md-7 col-sm-7 text-right">
              <p style="line-height: 25px">
                ОБЩЕСТВО <br> С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ <br> 346330, Россия. Ростовская область. <br>
                г. Донецк, ул. Ленина, 37а <br> Т/ф (86368) 23732 <br> E-mail: locomotiv_rostov@mail.ru <br> ОГРН 1146191001263 <br> ИНН/КПП 6145016260/614501001
              </p>
...
@media screen and (max-width: 768px) {
  .ptop-sm-5{padding-top:3rem!important}
  .info{
